const serviceList = {
    insurance: {
        ...
        text: "&emsp;&emsp;Part of the fleet's commercial operations include a most vital safety net which helps to recover after something bad has happened. Alexandria Shipping (Hellas) S.A. considers the insurances which are being placed for the fleet under management a very important part of its daily operations as they will serve as back-up at the time of emergency. Apart from the usual navigating risks which are more or less imposed by the freight market such as P&I coverage, Alexandria Shipping (Hellas) S.A. makes it a point to cover even those risks which are not explicitly demanded by its trading counter parts with a view to securing its interests and those of its stakeholders to the maximum extent possible.<br><br>In the light of the above, it was decided to assign the insurance & claims duties to a specific Insurance & Claims department which specialises in the following:<br><br><ul><li>Is responsible for the placing, monitoring and renewal of all insurances whether on an annual or on an occasional need basis.</li><li>Ensures that all the necessary insurance documentation is provided to the pertinent parties.</li><li>Arranges for precautionary surveys whenever deemed necessary in order to avoid potential claims.</li><li>Properly records and monitors insurance premium payments for reconciliation purposes.</li><li>Liaises with the pertinent departments over incidents giving rise to potential claims under the insurance policies with a view to deciding on strategy, mutual updating and requesting the necessary documentation/information in the handling of each case.</li><li>Prepares claims for submission to Brokers/Claims Handlers/Underwriters following collection of the relevant supporting documentation from the pertinent departments.</li><li>Peruses all insurance claims from early stages until closure and keeps proper records thereof.</li></ul>",
        banner: {
            image: "",
    ...
    operation: {
        title: "Operation",
        text: "&emsp;&emsp;One of the most important pillars of the company lies within the Operation department.<br><br>The operations department is the main coordinator among the company’s departments, the charterers, and all third parties involved with the ships (i.e. ship agents, ship-chandlers, bunkering suppliers, etc.).<br><br>The Operation department is liable for the following tasks:<br><br><ul><li>Promote and establish an awareness of safety and the need to protect the environment, amongst all fleet operating staff.</li><li>Ensure that Safe Cargo Operations are established on board (by issuing necessary instructions and procedures as necessary)</li><li>Ensure that the company’s Cargo related Procedures are effectively implemented on board.</li><li>Ensure that management objectives are met.</li><li>Dealing with Non-conformities covered ship and shore operations.</li><li>Investigate accidents reports regarding safety and insurance.</li><li>Appraise and appoint the local agents according to previous co-operations or third party recommendations.</li><li>Monitor day to day operational aspects of each ship and issue instructions to the ships where necessary.</li><li>Monitor the vessel performance against charter party requirements and intervene where necessary.</li><li>To arrange for the bunkering of the vessels.</li><li>To monitor freight collection.</li><li>To communicate proper voyage instructions to the Master and ensure that the Master is aware and familiar with all C/P terms and important details.</li><li>To communicate with Charterers whenever it is considered necessary, to ensure that they are satisfied with vessel’s performance and promote Company’s future co-operation with esteemed Charterers.</li></ul>",
        banner: {
            image: "",
            style: {},
        },
