const serviceList = {
    ...
    technical: {
        title: "Technical",
        text: "Based on a highly experienced and qualified staff of naval architects and marine engineers, the technical department establishes that each vessel’s hull, machinery and equipment is more than adequately monitored and maintained at highest possible standards. All known and new techniques are applied to always provide safety as well as to support, at a top level, the functionality and operation of the fleet.<br><br>The technical department is responsible: <ul><li>To plan and supervise all organization and technical activities regarding technical projects and the maintenance of Company’s fleet.</li><li>To ensure all the vessels classification society requirements are followed, especially with respect to maintaining the class status of vessels.</li><li>To initiate, control and perform actions necessary to ensure the quality, integrity and profitability as well as the contractual delivery time of the repairs and projects carried out by the Department.</li><li>To evaluate & control vessel’s expenditures for maintenance & repair purposes.</li><li>To minimize any vessel delays due to any unscheduled machinery/ equipment break down.</li></ul>",
        banner: {
            image: "",
    ...
    crewing: {
        title: "Crewing",
        text: "The Crew Department is responsible for ensuring that all vessels are efficiently and effectively manned with fully qualified and experienced seafarers in accordance with the relevant STCW & Flag Administration requirements.<br><br>Alexandria Shipping’s crewing management system is one of the company’s most thought out and broad procedures since the human element is certainly the most important of all factors.<br><br>The most important tasks of Alexandria Shipping’s Crew department are:<ul><li>To employ seafarers whose performance meets the company standards.</li><li>To improve the retention of seafarers with acceptable performance.</li><li>To implement an effective appraisal and training system for seafarers employed.</li><li>To employ Manning Agents that continuously and effectively meet the company requirements and the industry certification standards as stipulated by the STCW and the respective Flag Administrations.</li><li>To implement an effective and efficient D & A Program and to eliminate any positive results of alcohol and narcotics testing.</li><li>To implement an active promotion scheme for seafarers whose performance is good.</li><ul>",
        banner: {
            image: "",
            style: {},
        },
