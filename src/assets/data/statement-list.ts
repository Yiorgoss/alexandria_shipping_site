const statementList = {
    ...
    quality: {
        title: "Quality",
        text: "The Company is committed to providing a Quality service, which consistently & continuously meets the requirements of its customers whilst protecting assets under its care, its employees and the environment in general.<br><br>This is achieved by establishing/discharging managerial & operational processes, which have emerged from the combination of sound managerial principles and long lasted experience in the Shipping Industry.<br><br>The Company aims to remain a quality service provider by:<br><br><ul><li>Meeting customer requirements.</li><li>Developing and implementing controlled processes.</li><li>Continual improvements in operational responsiveness.</li><li>Establishing and communicating measurable & consistent objectives and performance targets to company employees.</li><li>Complying with applicable statutory requirements, international legislation and classification society requirements related to the services provided.</li><li>Operating vessels without accident(s) or incident(s) that could endanger company’s employees, the environment or assets under the company’s care.</li><li>Complying with current Health & Safety legislation and developing employee skills and increasing their contribution through effective training in order to meet the above objectives the company has developed and implements a Management System, which as a minimum shall meet the requirements of ISO 9001:2008, ISO 14001:2004 & IMO ISM Code.</li></ul>All Company employees are responsible for implementing the company's Quality Policy.<br><br>The Company's Management is responsible for monitoring and reviewing the Quality Policy at regular intervals in order to ensure that it remains relevant and effective.",
        banner: {
            image: "",
            style: {
